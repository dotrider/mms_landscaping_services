...
const data = [
    {
        id: 1,
        name: 'Maintenance',
        img: "https://cdn.pixabay.com/photo/2017/03/27/11/57/garden-2178234_1280.jpg",
        description: 'We provide regular scheduled maintance varying from weekly, Bi-weekly or monthly maintanance service depeding on your lawn needs. This ensures your property is kept in beautiful shape all year round whether is spring, summer, fall or winter your lawn will be treated accordingly. We also provide one time clean ups!',
        details: ['Lawn Mowing', 'Tree/Bush Trimming', 'Fertilizing', 'Edging', 'And More']
